...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2D68FE);
  late Color secondary = const Color(0xFFFFFFFF);
  late Color tertiary = const Color(0xFF515EA5);
  late Color alternate = const Color(0xFF6B9DFF);
  late Color primaryText = const Color(0xFF0B191E);
  late Color secondaryText = const Color(0xFF384E58);
  late Color primaryBackground = const Color(0xFF6B9DFF);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFF6B9DFF);
