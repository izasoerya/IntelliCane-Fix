...
import 'broadcast_mesaage_main_model.dart';
export 'broadcast_mesaage_main_model.dart';

class BroadcastMesaageMainWidget extends StatefulWidget {
  const BroadcastMesaageMainWidget({Key? key}) : super(key: key);

  @override
  _BroadcastMesaageMainWidgetState createState() =>
      _BroadcastMesaageMainWidgetState();
}

class _BroadcastMesaageMainWidgetState extends State<BroadcastMesaageMainWidget>
    with TickerProviderStateMixin {
  late BroadcastMesaageMainModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BroadcastMesaageMainModel());
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: StreamBuilder<
                                                          List<
                                                              TrackingPatientRecord>>(
                                                        stream:
                                                            queryTrackingPatientRecord(
                                                          queryBuilder:
                                                              (trackingPatientRecord) =>
                                                                  trackingPatientRecord
                                                                      .orderBy(
                                                                  ...
                                                                  child: Row(
                                                                    ...
                                                                    children: [
                                                                      Theme(
                                                                        ...
                                                                        child:
                                                                            Checkbox(
                                                                          value: _model.checkboxValueMap1[listViewTrackingPatientRecord] ??=
                                                                              true,
                                                                          onChanged:
                                                                              (newValue) async {
                                                                            setState(() =>
                                                                                _model.checkboxValueMap1[listViewTrackingPatientRecord] = newValue!);
                                                                          },
                                                                          activeColor:
                                                                              FlutterFlowTheme.of(context).primary,
                                                                          checkColor:
                                                                                ...
                                                                                Column(
                                                                                  ...
                                                                                  children: [
                                                                                    Padding(
                                                                                      ...
                                                                                      child: Text(
                                                                                        listViewTrackingPatientRecord.name,
